...
namespace BUS
{
    public class SuaBUS
    {
        ...
        //Them thuc an tam
        public int TangThucAnTamBUS(ThucAn_TamDTO thucantam)
        {
            try
            {
                return new SuaDAL().TangThucAnTamDAL(thucantam);
            }
            catch (SqlException ex)
            {
                throw ex;
        ...
        //Them thuc an tam
        public int GiamThucAnTamBUS(ThucAn_TamDTO thucantam)
        {
            try
            {
                return new SuaDAL().GiamThucAnTamDAL(thucantam);
            }
            catch (SqlException ex)
            {
                throw ex;
